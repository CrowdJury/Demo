...
switch (args[0]) {
    case 'mine':
        var mineAddress = require('./blockchain/accounts').admin.address;
        console.log(args);
        if (args.indexOf("--user") >= 0)
            mineAddress = require('./blockchain/accounts').users[args.indexOf("--user")+1].address;
